...
by2olak_data_proper_status <- by2olak_data_proper_status[by2olak_data_proper_status$road_status_id <= 5,]
...
estimate_mode(by2olak_data$road_status_id)
estimate_mode(by2olak_data$report_status_id)
estimate_mode(by2olak_data$road_update_hours_ago)
estimate_mode(by2olak_data$report_update_hours_ago)
...
plot(factor(table(by2olak_data['road_status_id'])))
barplot(table(by2olak_data['road_status_id']), main = "barplot")
plot(table(by2olak_data['report_status_id']))
plot(factor(table(by2olak_data['report_status_id'])))
barplot(table(by2olak_data['report_status_id']), main = "barplot")
...
ggplot(by2olak_data, aes(road_status_id, group=anonymous)) + 
    geom_histogram(aes(colour=anonymous, fill=anonymous), binwidth=1, alpha=0.9) +
    xlab("Roads Status") + ylab("Count") + ggtitle("Roads Status by fa3el kheir")

ggplot(by2olak_data, aes(report_status_id, group=anonymous)) + 
    geom_histogram(aes(colour=anonymous, fill=anonymous), binwidth=1, alpha=0.9) +
    xlab("Reports Status") + ylab("Count") + ggtitle("Reports Status by fa3el kheir")
...
```{r}
pie(table(by2olak_data$report_status_id))
pie(table(by2olak_data$road_status_id))
```
