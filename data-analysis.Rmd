...
### Speed Distribution per each Day 

```{r, message = FALSE}
by2olak_data_proper_speed <- by2olak_data[by2olak_data$gps== TRUE & by2olak_data$speed < 180,] 
ggplot(by2olak_data_proper_speed , aes(speed, group=actual_day)) + 
geom_histogram(aes(colour=actual_day, fill=actual_day), binwidth=0.2, alpha=0.9) + ggtitle("Speed Distribution per each day")
```
